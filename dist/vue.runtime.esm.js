...
function initMixin (Vue) {
  Vue.prototype._init = function (options) {
    ...
    // TODO 核心初始化过程
    vm._self = vm;
    initLifecycle(vm); //TODO parent/root/refs/childer
    initEvents(vm); //TODO 组件上自定义事件监听
    initRender(vm); //TODO $slots/$scopeSlots/_c/$createElement()
    callHook(vm, 'beforeCreate'); // TODO 调用 beforeCreate 钩子
    // TODO 接下来处理组件数据和状态
    initInjections(vm); // resolve injections before data/props
    initState(vm); //TODO props/data/methods/computed/watch
